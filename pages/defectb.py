...
class DefectB(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.cap = None
        self.imgtk = None  # Store reference here instead of Label attribute
    ...
    def start_camera(self):
        """Start the webcam feed only if logged in."""
    ...
    def update_frame(self):
        """Update camera frames continuously."""
